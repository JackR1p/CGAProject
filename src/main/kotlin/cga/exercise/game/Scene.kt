...
class Scene(private val window: GameWindow) {
    ...
    init {
        ...
        val monument = OBJLoader.loadOBJ("C:/Users/Julien/dev/cga/CGAFramework/assets/models/Monument.obj")

        //playermodel.scaleLocal(Vector3f(0.8f, 0.8f, 0.8f))

        // Model muss selbes Rig benutzen wie das loadModel Object
        human = ModelLoader.loadDAEModel("C:/Users/Julien/dev/cga/CGAFramework/assets/models/humanMTBNew.dae")
        human.scaleLocal(Vector3f(0.2f, 0.2f, 0.2f))
        human.shader = anim_shader
        human.animator.animations = ModelLoader.loadAnimations("C:/Users/Julien/dev/cga/CGAFramework/assets/models/Animations/Walking1.dae")
        ...
        //troncam.translateLocal(Vector3f(0f, 15f, 3f))
